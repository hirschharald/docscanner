...
export const DocumentModal = React.memo<DocumentModalProps>(({ document, onClose, onCropSave }) => {
  ...
  return (
    <div className="modal d-block" tabIndex={-1} style={{ background: 'rgba(0,0,0,0.7)' }} onClick={onClose}>
        ...
        <div className="modal-content">
          ...
          <div className="modal-footer justify-content-between">
            ...
            <div className="d-flex gap-2">
              ...
              <button className="btn btn-primary btn-sm" onClick={handleDownload}>⬇ Herunterladen</button>
